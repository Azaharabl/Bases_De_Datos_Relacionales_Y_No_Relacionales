...
public interface AppDatabaseQueries : Transacter {
  ...
  public fun findById(id: Long): Query<Cars>
  ...
  public fun findByUuid(uuid: String?): Query<Cars>
  ...
  public fun exixstsById(id: Long): Query<Cars>
